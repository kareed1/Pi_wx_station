...
#---------------Wind speed------------------#
#**MOVED DOWN TO "TAKE MEASUREMENTS" SECTION B/C IT INTERFERRED W/ TAKING SUBSEQUENT MEASURE**
...
time_interval = 10 #amount of time (in seconds) anemometer rotations are measured
...
rain_time = time.time() + 900 #time (in seconds) to measure rain bucket tips; 15'
def tip():
    global tip_count
